package com.example.pokemon_firebase.menu.utilidades;
...
public class ImageFirebase {
    ...
    public ImageFirebase() {
        this.storage  = FirebaseStorage.getInstance();
        this.storageRef = this.storage.getReference();
    }


    public void subirFoto(final FotoStatus fotoStatus, String email, String idPokemon, ImageView img_add_foto) {
        ...
        StorageReference foto2Ref = storageRef.child(email+"/"+String.valueOf(idPokemon)+".png");
    ...
    public void descargarFoto(final ImageFirebase.FotoStatus fotoStatus, String foto) {
        FirebaseStorage storage = FirebaseStorage.getInstance();
        StorageReference storageRef = storage.getReference();
    ...
    public void borrarFoto(final ImageFirebase.FotoStatus fotoStatus, String foto) {
        FirebaseStorage storage = FirebaseStorage.getInstance();
        StorageReference storageRef = storage.getReference();
        StorageReference islandRef = storageRef.child(foto);
